...
from ...components.input.CheckBox import InputCheck
...
class WidgetsInterface(GalleryInterface):
    def __init__(self, parent=None):
        ...
        super().__init__(
            title=self.trans["widgets"], subtitle="Widgets page", parent=parent
        )
        ...
        self.selectGenre = Select(
            self.trans["combox"], ["Options 1", "Options 2"], self.row
        )
