...
from ...common.config import HELP_URL, Lang
...
class BannerWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.galleryLabel = QLabel("PyQt Fluent Widgets", self)
        ...
        self.linkCardView.addCard(
            logo_path,
            self.tr("Get Started"),
            self.tr("Create your best interface with PyQt Fluent"),
            HELP_URL,
        )
        """
...
class HomeInterface(ScrollArea):
    ...
    def loadSamples(self):
        """load samples"""
        # basic input samples
        basicInputView = SampleCardView(self.trans["widgets"], self.view)
        basicInputView.addSampleCard(
            icon=":/gallery/images/controls/Button.png",
            title="Widgets",
            content=self.tr("Controls respond to user needs"),
...
"""
        ...
        collectionView.addSampleCard(
            ...
            title="TableView",
            content=self.tr(
                "The data grid control provides a flexible way to display a collection of data in rows and columns"
            ),
